...
// When VNC_ENABLED=1, run Chrome with a real window so it's visible over VNC/noVNC
const VNC_ENABLED = process.env.VNC_ENABLED === "1";
...
async function initBrowser() {
  ...
  try {
    ...
    browser = await puppeteer.launch({
      headless: VNC_ENABLED ? false : "new",
